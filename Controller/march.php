...
<a href="logout.php" style="margin-left: 20px; color:#4d0039; background:#17A4E2" >LOGOUT </a>
	   ...
	   <section id "section1">
	   <div class ="row">
	   <div class="col-md-12" style="font-size: 40px; text-align: center; color:#1016EA;">Transaction of March 2020 </div>
		 <div class = "row" style ="padding:5px;">
				<table border height ="50px" width= "80%">
	             <tr>
					 ...
					 $sql = "SELECT * FROM statement WHERE month= 'March' ORDER BY date DESC";
